    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 pt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="max-w-3xl mx-auto mb-16">
          <div className="flex gap-4">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-3 bg-primary-500 hover:bg-primary-600 text-white rounded-lg font-semibold flex items-center"
            >
        ...
        <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 mb-16">
          <h2 className="text-3xl font-bold text-center mb-8">Popular Domain Extensions</h2>
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8">
            Our domain experts are here to help you choose and configure your domain
          </p>
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
...
const DomainPriceCard = ({ extension, price }) => (
  <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow text-center">
    ...
    <p className="text-3xl font-bold text-primary-500">${price}<span className="text-sm text-gray-500">/year</span></p>
  </div>
);